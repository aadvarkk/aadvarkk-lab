...
class RequestHandler(object):
    ...
    # NICEGOORI
    def _execute_no_finish(self, transforms, *args, **kwargs):
...
class ChunkedRequestHandler(RequestHandler):
    """
    def on_chunk_rcvd(self, data):
        print 'on_chunk_rcvd called'
        pass
...
class Application(object):
    ...
    # NICEGOORI
    def exec_handler(self, handler, transforms, args, kwargs):
        handler._execute_no_finish(transforms, *args, **kwargs)
        return handler
